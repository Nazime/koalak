...
#     ],
# )
def test_method_sum_with_int_argument(
...
#     ],
# )
def test_method_sum_with_lambda(
    container_type, accessor_function, data, iter_func, use_function
):
    data = iter_func(data)
    ...
    assert function(data, lambda x: accessor_function(x, "money") * 2) == 1200
